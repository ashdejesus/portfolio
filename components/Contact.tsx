      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="space-y-1 flex flex-col h-full">
            <a target="_blank" rel="noopener noreferrer" className="block p-2.5 rounded-lg border border-foreground/10 hover:bg-foreground/5 transition-all duration-200 hover:-translate-y-0.5 group flex-1" href="https://www.aap.ph">
              <div className="flex items-start justify-between gap-1 h-full">
                <p className="text-[10px] font-medium leading-tight text-foreground group-hover:text-black transition-colors">Analytics &amp; Artificial Intelligence Association of the Philippines (AAP)</p>
            ...
            <a target="_blank" rel="noopener noreferrer" className="block p-2.5 rounded-lg border border-foreground/10 hover:bg-foreground/5 transition-all duration-200 hover:-translate-y-0.5 group flex-1" href="https://www.psia.org.ph">
              <div className="flex items-start justify-between gap-1 h-full">
                <p className="text-[10px] font-medium leading-tight text-foreground group-hover:text-black transition-colors">Philippine Software Industry Association</p>
                <svg className="w-2.5 h-2.5 text-foreground/50 transition-transform group-hover:translate-x-0.5 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                </svg>
              </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-1 gap-1">
            <a target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-1.5 rounded-lg border border-foreground/10 hover:bg-foreground/5 transition-all duration-200 hover:-translate-y-0.5 group" aria-label="Visit LinkedIn profile" title="Visit LinkedIn profile" href="https://linkedin.com/in/yourusername">
              <div className="text-foreground group-hover:text-black transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path>
                </svg>
              </div>
              <p className="text-[10px] font-medium text-foreground group-hover:text-black transition-colors">LinkedIn</p>
            </a>
            <a target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-1.5 rounded-lg border border-foreground/10 hover:bg-foreground/5 transition-all duration-200 hover:-translate-y-0.5 group" aria-label="Visit GitHub profile" title="Visit GitHub profile" href="https://github.com/ashdejesus">
              ...
              <p className="text-[10px] font-medium text-foreground group-hover:text-black transition-colors">GitHub</p>
            </a>
            <a target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-1.5 rounded-lg border border-foreground/10 hover:bg-foreground/5 transition-all duration-200 hover:-translate-y-0.5 group" aria-label="Visit Instagram profile" title="Visit Instagram profile" href="https://www.instagram.com/yourusername">
              <div className="text-foreground group-hover:text-black transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <p className="text-[10px] font-medium text-foreground group-hover:text-black transition-colors">Instagram</p>
            </a>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between space-y-1.5">
          ...
          <div className="group p-3 rounded-lg border border-foreground/10 hover:bg-foreground/5 transition-all duration-200 flex flex-col justify-between h-full">
            ...
            <a className="text-[10px] font-medium text-black hover:underline inline-flex items-center gap-1 group/link" href="mailto:dejesusnichoeashley81@gmail.com">Get in touch<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5l7 7-7 7"></path></svg></a>
          </div>
        </div>
        ...
        <div className="space-y-1">
          <div className="space-y-1">
            <a className="group p-1.5 rounded-md border border-foreground/10 hover:bg-foreground/5 transition-all duration-200 hover:-translate-y-0.5 block" href="mailto:dejesusnichoeashley81@gmail.com">
              ...
              <p className="text-[9px] font-medium text-foreground group-hover:text-black transition-colors">dejesusnichoeashley81@gmail.com</p>
            </a>
            <a target="_blank" className="group p-1.5 rounded-md border border-foreground/10 hover:bg-foreground/5 transition-all duration-200 hover:-translate-y-0.5 block" href="https://calendly.com">
              <div className="flex items-center gap-1 mb-0.5">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a className="group p-1.5 rounded-md border border-foreground/10 hover:bg-foreground/5 transition-all duration-200 hover:-translate-y-0.5 block" href="#">
              ...
              <div className="flex items-center justify-between">
                <span className="text-[9px] font-medium text-white group-hover:text-white transition-colors">Join Discussion</span>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5l7 7-7 7"></path>
                </svg>
              </div>
