      ...
      <div className="flex items-center gap-4 md:gap-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <button className="relative inline-flex h-6 w-11 items-center rounded-full transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 min-h-0 min-w-0 bg-gray-300 hover:bg-gray-400" aria-label="Toggle theme">
              <div className="absolute left-0.5 top-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-white shadow-lg transition-all duration-300 ease-in-out translate-x-0">
          ...
          <div className="flex items-center justify-between mt-1.5 md:mt-2">
            <p className="text-[10px] md:text-base">3rd Year Computer Science Student <span className="text-gray-400">\</span> Aspiring Full-Stack Developer</p>
